...
function App($$anchor, $$props) {
	...
	each(div_8, 21, () => sidebarFilterOptions, (filter) => filter.key, ($$anchor, filter) => {
		var button_4 = root_3();
		var text_2 = only_child(button_4, true);
		template_effect(() => {
	...
	var text_8 = only_child(button_9, true);
